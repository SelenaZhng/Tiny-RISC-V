...
extern "C" {
  ...
  #if VLINETRACE
  void VProcDpathImmGen_noparam_line_trace( VProcDpathImmGen_noparam_t *, char * );
  #endif
...
VProcDpathImmGen_noparam_t * VProcDpathImmGen_noparam_create_model( const char *vcd_filename ) {
  ...
  m     = new VProcDpathImmGen_noparam_t;
  model = new VProcDpathImmGen_noparam(context_ptr);
...
void VProcDpathImmGen_noparam_destroy_model( VProcDpathImmGen_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcDpathImmGen_noparam * model = (VProcDpathImmGen_noparam *) m->_cffi_model;
...
void VProcDpathImmGen_noparam_comb_eval( VProcDpathImmGen_noparam_t * m ) {
...
void VProcDpathImmGen_noparam_seq_eval( VProcDpathImmGen_noparam_t * m ) {
...
void VProcDpathImmGen_noparam_assert_on( VProcDpathImmGen_noparam_t * m, bool enable ) {
...
bool VProcDpathImmGen_noparam_has_assert_fired( VProcDpathImmGen_noparam_t * m ) {
...
#if VLINETRACE
void VProcDpathImmGen_noparam_line_trace( VProcDpathImmGen_noparam_t * m, char* str ) {
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.ProcDpathImmGen_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VProcDpathImmGen_noparam::line_trace( words );
