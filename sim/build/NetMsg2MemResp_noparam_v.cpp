...
#include "obj_dir_NetMsg2MemResp_noparam/VNetMsg2MemResp_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetMsg2MemResp_noparam/VNetMsg2MemResp_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void VNetMsg2MemResp_noparam_line_trace( VNetMsg2MemResp_noparam_t *, char * );
  #endif
...
VNetMsg2MemResp_noparam_t * VNetMsg2MemResp_noparam_create_model( const char *vcd_filename ) {

  VNetMsg2MemResp_noparam_t  * m;
  VNetMsg2MemResp_noparam * model;
  ...
  m     = new VNetMsg2MemResp_noparam_t;
  model = new VNetMsg2MemResp_noparam(context_ptr);
...
void VNetMsg2MemResp_noparam_destroy_model( VNetMsg2MemResp_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetMsg2MemResp_noparam * model = (VNetMsg2MemResp_noparam *) m->_cffi_model;
...
void VNetMsg2MemResp_noparam_comb_eval( VNetMsg2MemResp_noparam_t * m ) {
...
void VNetMsg2MemResp_noparam_seq_eval( VNetMsg2MemResp_noparam_t * m ) {
...
void VNetMsg2MemResp_noparam_assert_on( VNetMsg2MemResp_noparam_t * m, bool enable ) {
...
bool VNetMsg2MemResp_noparam_has_assert_fired( VNetMsg2MemResp_noparam_t * m ) {
...
#if VLINETRACE
void VNetMsg2MemResp_noparam_line_trace( VNetMsg2MemResp_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_NetMsg2MemResp_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.NetMsg2MemResp_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VNetMsg2MemResp_noparam::line_trace( words );
