...
VL_ATTR_COLD void VNetRouterSwitchUnit___05Fp_msg_nbits_44___024unit___ctor_var_reset(VNetRouterSwitchUnit___05Fp_msg_nbits_44___024unit* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VNetRouterSwitchUnit___05Fp_msg_nbits_44__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VNetRouterSwitchUnit___05Fp_msg_nbits_44___024unit___ctor_var_reset\n"); );
}
