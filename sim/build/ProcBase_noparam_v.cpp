...
#include "obj_dir_ProcBase_noparam/VProcBase_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcBase_noparam/VProcBase_noparam__Syms.h"
#include "svdpi.h"
#endif
...
VProcBase_noparam_t * VProcBase_noparam_create_model( const char *vcd_filename ) {

  VProcBase_noparam_t  * m;
  VProcBase_noparam * model;
  ...
  m     = new VProcBase_noparam_t;
  model = new VProcBase_noparam(context_ptr);
...
void VProcBase_noparam_destroy_model( VProcBase_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcBase_noparam * model = (VProcBase_noparam *) m->_cffi_model;
...
void VProcBase_noparam_comb_eval( VProcBase_noparam_t * m ) {
...
void VProcBase_noparam_seq_eval( VProcBase_noparam_t * m ) {
...
void VProcBase_noparam_assert_on( VProcBase_noparam_t * m, bool enable ) {
...
bool VProcBase_noparam_has_assert_fired( VProcBase_noparam_t * m ) {
...
#if VLINETRACE
void VProcBase_noparam_line_trace( VProcBase_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_ProcBase_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.ProcBase_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VProcBase_noparam::line_trace( words );
