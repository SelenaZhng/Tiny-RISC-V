...
class NetRouterRouteUnit__p_msg_nbits_44( Component ):
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s._ffi_inst = s.ffi.dlopen('./libNetRouterRouteUnit__p_msg_nbits_44_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    s._ffi_m = s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_seq_eval

    # declare the port interface
    s.router_id = InPort( Bits4 )
    s.istream = IStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_32 )
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 1:
      s._ffi_inst.VNetRouterRouteUnit__p_msg_nbits_44_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
      return s._convert_string( s._ffi_m._cffi_line_trace_str ).decode('ascii')
    else:
      return f' clk={s.clk}, reset={s.reset}, router_id={s.router_id}, istream.msg={s.istream.msg}, istream.rdy={s.istream.rdy}, istream.val={s.istream.val}, ostream[0].msg={s.ostream[0].msg}, ostream[1].msg={s.ostream[1].msg}, ostream[2].msg={s.ostream[2].msg}, ostream[0].rdy={s.ostream[0].rdy}, ostream[1].rdy={s.ostream[1].rdy}, ostream[2].rdy={s.ostream[2].rdy}, ostream[0].val={s.ostream[0].val}, ostream[1].val={s.ostream[1].val}, ostream[2].val={s.ostream[2].val},'
