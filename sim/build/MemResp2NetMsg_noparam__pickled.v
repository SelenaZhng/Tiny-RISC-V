...
// PyMTL VerilogPlaceholder MemResp2NetMsg Definition
// At /home/scz6/ece4750/lab-group74/sim/lab4_sys/NetMsgAdapters.py

//***********************************************************
// Pickled source file of placeholder MemResp2NetMsg_noparam
//***********************************************************

//-----------------------------------------------------------
// Dependency of placeholder MemResp2NetMsg
//-----------------------------------------------------------

`ifndef MEMRESP2NETMSG
`define MEMRESP2NETMSG

// The source code below are included because they are specified
// as the v_libs Verilog placeholder option of component MemResp2NetMsg_noparam.
...
// End of all v_libs files for component MemResp2NetMsg_noparam
...
`endif /* MEMRESP2NETMSG */
//-----------------------------------------------------------
// Wrapper of placeholder MemResp2NetMsg_noparam
//-----------------------------------------------------------

`ifndef MEMRESP2NETMSG_NOPARAM
`define MEMRESP2NETMSG_NOPARAM

module MemResp2NetMsg_noparam
(
  input logic reset,
  input logic clk,
  input logic [146-1:0] istream_msg ,
  output logic [1-1:0] istream_rdy ,
  input logic [1-1:0] istream_val ,
  output logic [158-1:0] ostream_msg ,
  input logic [1-1:0] ostream_rdy ,
  output logic [1-1:0] ostream_val 
);
  lab4_sys_MemResp2NetMsg
  #(
  ) v
  (
