...
// PyMTL BitStruct NetMsg__src_2__dest_2__opaque_8__payload_78 Definition
typedef struct packed {
  logic [1:0] src;
  logic [1:0] dest;
  logic [7:0] opaque;
  logic [77:0] payload;
} NetMsg__src_2__dest_2__opaque_8__payload_78;

// PyMTL VerilogPlaceholder CacheReq2NetMsg Definition
// At /home/scz6/ece4750/lab-group74/sim/lab4_sys/NetMsgAdapters.py

//***********************************************************
// Pickled source file of placeholder CacheReq2NetMsg_noparam
//***********************************************************

//-----------------------------------------------------------
// Dependency of placeholder CacheReq2NetMsg
//-----------------------------------------------------------

`ifndef CACHEREQ2NETMSG
`define CACHEREQ2NETMSG

// The source code below are included because they are specified
// as the v_libs Verilog placeholder option of component CacheReq2NetMsg_noparam.
...
// End of all v_libs files for component CacheReq2NetMsg_noparam
...
`endif /* CACHEREQ2NETMSG */
//-----------------------------------------------------------
// Wrapper of placeholder CacheReq2NetMsg_noparam
//-----------------------------------------------------------

`ifndef CACHEREQ2NETMSG_NOPARAM
`define CACHEREQ2NETMSG_NOPARAM

module CacheReq2NetMsg_noparam
(
  input logic reset,
  input logic clk,
  input logic [2-1:0] src_id ,
  input logic [78-1:0] istream_msg ,
  output logic [1-1:0] istream_rdy ,
  input logic [1-1:0] istream_val ,
  output logic [90-1:0] ostream_msg ,
  input logic [1-1:0] ostream_rdy ,
  output logic [1-1:0] ostream_val 
);
  lab4_sys_CacheReq2NetMsg
  #(
  ) v
  (
    .src_id( src_id ),
