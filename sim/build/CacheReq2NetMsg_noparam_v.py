...
#-------------------------------------------------------------------------
# CacheReq2NetMsg_noparam
#-------------------------------------------------------------------------

class CacheReq2NetMsg_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VCacheReq2NetMsg_noparam_t;

      VCacheReq2NetMsg_noparam_t * VCacheReq2NetMsg_noparam_create_model( const char * );
      void VCacheReq2NetMsg_noparam_destroy_model( VCacheReq2NetMsg_noparam_t *);
      void VCacheReq2NetMsg_noparam_comb_eval( VCacheReq2NetMsg_noparam_t * );
      void VCacheReq2NetMsg_noparam_seq_eval( VCacheReq2NetMsg_noparam_t * );
      void VCacheReq2NetMsg_noparam_assert_on( VCacheReq2NetMsg_noparam_t *, bool );
      bool VCacheReq2NetMsg_noparam_has_assert_fired( VCacheReq2NetMsg_noparam_t * );
    ...
    #       'libCacheReq2NetMsg_noparam_v.so', os.path.getmtime( './libCacheReq2NetMsg_noparam_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libCacheReq2NetMsg_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    CacheReq2NetMsg_noparam.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VCacheReq2NetMsg_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if int(s._ip_cfg.vl_trace):
      if bool(s._ip_cfg.vl_trace_filename):
        ...
        verilator_vcd_file = "CacheReq2NetMsg_noparam.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VCacheReq2NetMsg_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VCacheReq2NetMsg_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VCacheReq2NetMsg_noparam_seq_eval

    # declare the port interface
    s.src_id = InPort( Bits2 )
    s.istream = IStreamIfc( MemReqMsg__type__4__opaque_8__addr_32__len_2__data_32 )
    s.ostream = OStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_78 )
    ...
    s.s_DOT_istream_DOT_msg = Wire( Bits78 )
    @update
    ...
    s.s_DOT_ostream_DOT_msg = Wire( Bits90 )
    @update
    def ostruct_s_DOT_ostream_DOT_msg():
      s.ostream.msg.payload @= s.s_DOT_ostream_DOT_msg[0:78]
      s.ostream.msg.opaque @= s.s_DOT_ostream_DOT_msg[78:86]
      s.ostream.msg.dest @= s.s_DOT_ostream_DOT_msg[86:88]
      s.ostream.msg.src @= s.s_DOT_ostream_DOT_msg[88:90]
    ...
    def comb_upblk():
      ...
      x[2] = int(s.s_DOT_istream_DOT_msg[64:78])
      ...
      s.s_DOT_ostream_DOT_msg[64:90] @= x[2]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VCacheReq2NetMsg_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VCacheReq2NetMsg_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 0:
      s._ffi_inst.VCacheReq2NetMsg_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
