...
#include "obj_dir_Net__p_msg_nbits_44/VNet___05Fp_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_Net__p_msg_nbits_44/VNet___05Fp_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
VNet__p_msg_nbits_44_t * VNet__p_msg_nbits_44_create_model( const char *vcd_filename ) {

  VNet__p_msg_nbits_44_t  * m;
  VNet___05Fp_msg_nbits_44 * model;
  ...
  m     = new VNet__p_msg_nbits_44_t;
  model = new VNet___05Fp_msg_nbits_44(context_ptr);
...
void VNet__p_msg_nbits_44_destroy_model( VNet__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNet___05Fp_msg_nbits_44 * model = (VNet___05Fp_msg_nbits_44 *) m->_cffi_model;
...
void VNet__p_msg_nbits_44_comb_eval( VNet__p_msg_nbits_44_t * m ) {
...
void VNet__p_msg_nbits_44_seq_eval( VNet__p_msg_nbits_44_t * m ) {
...
void VNet__p_msg_nbits_44_assert_on( VNet__p_msg_nbits_44_t * m, bool enable ) {
...
bool VNet__p_msg_nbits_44_has_assert_fired( VNet__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void VNet__p_msg_nbits_44_line_trace( VNet__p_msg_nbits_44_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_Net___05Fp_msg_nbits_44__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.Net__p_msg_nbits_44.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VNet___05Fp_msg_nbits_44::line_trace( words );
