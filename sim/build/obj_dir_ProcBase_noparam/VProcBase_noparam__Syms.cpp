    ...
    , TOP{this, namep}
{
    ...
    __Vscope_ProcBase_noparam__v__dpath__imul__ctrl.configure(this, name(), "ProcBase_noparam.v.dpath.imul.ctrl", "ctrl", -12, VerilatedScope::SCOPE_OTHER);
