//========================================================================
// VNetRouterSwitchUnit__p_msg_nbits_44_v.cpp
//========================================================================
...
#include "obj_dir_NetRouterSwitchUnit__p_msg_nbits_44/VNetRouterSwitchUnit___05Fp_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetRouterSwitchUnit__p_msg_nbits_44/VNetRouterSwitchUnit___05Fp_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  typedef struct {
    ...
    uint8_t * clk;
    uint8_t * reset;
    uint64_t * istream_msg[3];
    uint8_t * istream_rdy[3];
    uint8_t * istream_val[3];
    uint64_t * ostream_msg;
    uint8_t * ostream_rdy;
    uint8_t * ostream_val;
  ...
  // Exposed methods
  VNetRouterSwitchUnit__p_msg_nbits_44_t * VNetRouterSwitchUnit__p_msg_nbits_44_create_model( const char * );
  void VNetRouterSwitchUnit__p_msg_nbits_44_destroy_model( VNetRouterSwitchUnit__p_msg_nbits_44_t *);
  void VNetRouterSwitchUnit__p_msg_nbits_44_comb_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * );
  void VNetRouterSwitchUnit__p_msg_nbits_44_seq_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * );
  void VNetRouterSwitchUnit__p_msg_nbits_44_assert_on( VNetRouterSwitchUnit__p_msg_nbits_44_t *, bool );
  bool VNetRouterSwitchUnit__p_msg_nbits_44_has_assert_fired( VNetRouterSwitchUnit__p_msg_nbits_44_t * );
  ...
  #if VLINETRACE
  void VNetRouterSwitchUnit__p_msg_nbits_44_line_trace( VNetRouterSwitchUnit__p_msg_nbits_44_t *, char * );
  #endif
...
VNetRouterSwitchUnit__p_msg_nbits_44_t * VNetRouterSwitchUnit__p_msg_nbits_44_create_model( const char *vcd_filename ) {

  VNetRouterSwitchUnit__p_msg_nbits_44_t  * m;
  VNetRouterSwitchUnit___05Fp_msg_nbits_44 * model;
  ...
  m     = new VNetRouterSwitchUnit__p_msg_nbits_44_t;
  model = new VNetRouterSwitchUnit___05Fp_msg_nbits_44(context_ptr);
  ...
  for ( int i_0 = 0; i_0 < 3; i_0++ )
    ...
    m->istream_msg[i_0] = &model->istream_msg[i_0];

  for ( int i_0 = 0; i_0 < 3; i_0++ )

    m->istream_rdy[i_0] = &model->istream_rdy[i_0];

  for ( int i_0 = 0; i_0 < 3; i_0++ )

    m->istream_val[i_0] = &model->istream_val[i_0];
...
void VNetRouterSwitchUnit__p_msg_nbits_44_destroy_model( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetRouterSwitchUnit___05Fp_msg_nbits_44 * model = (VNetRouterSwitchUnit___05Fp_msg_nbits_44 *) m->_cffi_model;
...
void VNetRouterSwitchUnit__p_msg_nbits_44_comb_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {
...
void VNetRouterSwitchUnit__p_msg_nbits_44_seq_eval( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {
...
void VNetRouterSwitchUnit__p_msg_nbits_44_assert_on( VNetRouterSwitchUnit__p_msg_nbits_44_t * m, bool enable ) {
...
bool VNetRouterSwitchUnit__p_msg_nbits_44_has_assert_fired( VNetRouterSwitchUnit__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void VNetRouterSwitchUnit__p_msg_nbits_44_line_trace( VNetRouterSwitchUnit__p_msg_nbits_44_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_NetRouterSwitchUnit___05Fp_msg_nbits_44__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.NetRouterSwitchUnit__p_msg_nbits_44.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VNetRouterSwitchUnit___05Fp_msg_nbits_44::line_trace( words );
