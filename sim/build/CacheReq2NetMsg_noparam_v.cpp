//========================================================================
// VCacheReq2NetMsg_noparam_v.cpp
//========================================================================
...
#include "obj_dir_CacheReq2NetMsg_noparam/VCacheReq2NetMsg_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheReq2NetMsg_noparam/VCacheReq2NetMsg_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void VCacheReq2NetMsg_noparam_line_trace( VCacheReq2NetMsg_noparam_t *, char * );
  #endif
...
VCacheReq2NetMsg_noparam_t * VCacheReq2NetMsg_noparam_create_model( const char *vcd_filename ) {

  VCacheReq2NetMsg_noparam_t  * m;
  VCacheReq2NetMsg_noparam * model;
  ...
  m     = new VCacheReq2NetMsg_noparam_t;
  model = new VCacheReq2NetMsg_noparam(context_ptr);
...
void VCacheReq2NetMsg_noparam_destroy_model( VCacheReq2NetMsg_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheReq2NetMsg_noparam * model = (VCacheReq2NetMsg_noparam *) m->_cffi_model;
...
void VCacheReq2NetMsg_noparam_comb_eval( VCacheReq2NetMsg_noparam_t * m ) {
...
void VCacheReq2NetMsg_noparam_seq_eval( VCacheReq2NetMsg_noparam_t * m ) {
...
void VCacheReq2NetMsg_noparam_assert_on( VCacheReq2NetMsg_noparam_t * m, bool enable ) {
...
bool VCacheReq2NetMsg_noparam_has_assert_fired( VCacheReq2NetMsg_noparam_t * m ) {
...
#if VLINETRACE
void VCacheReq2NetMsg_noparam_line_trace( VCacheReq2NetMsg_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheReq2NetMsg_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheReq2NetMsg_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheReq2NetMsg_noparam::line_trace( words );
