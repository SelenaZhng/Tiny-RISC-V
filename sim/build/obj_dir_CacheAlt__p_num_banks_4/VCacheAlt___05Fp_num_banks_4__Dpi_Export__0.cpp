...
void VCacheAlt___05Fp_num_banks_4::line_trace(svBitVecVal* trace_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCacheAlt___05Fp_num_banks_4___024root::line_trace\n"); );
    // Init
    ...
    VCacheAlt___05Fp_num_banks_4__Vcb_line_trace_t __Vcb = (VCacheAlt___05Fp_num_banks_4__Vcb_line_trace_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_W_SVBV(4096,trace_str__Vcvt,trace_str + 0);
(*__Vcb)((VCacheAlt___05Fp_num_banks_4__Syms*)(__Vscopep->symsp()), trace_str__Vcvt);
