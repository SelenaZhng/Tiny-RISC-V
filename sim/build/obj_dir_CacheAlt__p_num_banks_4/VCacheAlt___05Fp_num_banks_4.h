...
#ifndef VERILATED_VCACHEALT___05FP_NUM_BANKS_4_H_
#define VERILATED_VCACHEALT___05FP_NUM_BANKS_4_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class VCacheAlt___05Fp_num_banks_4__Syms;
class VCacheAlt___05Fp_num_banks_4___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VCacheAlt___05Fp_num_banks_4 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VCacheAlt___05Fp_num_banks_4___024root* const rootp;
    ...
    explicit VCacheAlt___05Fp_num_banks_4(VerilatedContext* contextp, const char* name = "TOP");
    explicit VCacheAlt___05Fp_num_banks_4(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VCacheAlt___05Fp_num_banks_4();
  private:
    VL_UNCOPYABLE(VCacheAlt___05Fp_num_banks_4);  ///< Copying not allowed
