...
#=========================================================================
# VCacheResp2NetMsg_noparam_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# CacheResp2NetMsg_noparam
#-------------------------------------------------------------------------

class CacheResp2NetMsg_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VCacheResp2NetMsg_noparam_t;

      VCacheResp2NetMsg_noparam_t * VCacheResp2NetMsg_noparam_create_model( const char * );
      void VCacheResp2NetMsg_noparam_destroy_model( VCacheResp2NetMsg_noparam_t *);
      void VCacheResp2NetMsg_noparam_comb_eval( VCacheResp2NetMsg_noparam_t * );
      void VCacheResp2NetMsg_noparam_seq_eval( VCacheResp2NetMsg_noparam_t * );
      void VCacheResp2NetMsg_noparam_assert_on( VCacheResp2NetMsg_noparam_t *, bool );
      bool VCacheResp2NetMsg_noparam_has_assert_fired( VCacheResp2NetMsg_noparam_t * );
    ...
    #       'libCacheResp2NetMsg_noparam_v.so', os.path.getmtime( './libCacheResp2NetMsg_noparam_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libCacheResp2NetMsg_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    CacheResp2NetMsg_noparam.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VCacheResp2NetMsg_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if int(s._ip_cfg.vl_trace):
      if bool(s._ip_cfg.vl_trace_filename):
        ...
        verilator_vcd_file = "CacheResp2NetMsg_noparam.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VCacheResp2NetMsg_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VCacheResp2NetMsg_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VCacheResp2NetMsg_noparam_seq_eval

    # declare the port interface
    s.istream = IStreamIfc( MemRespMsg__type__4__opaque_8__test_2__len_2__data_32 )
    s.ostream = OStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_48 )

    # update blocks that converts ffi interface to/from pymtl ports
    
    s.s_DOT_istream_DOT_msg = Wire( Bits48 )
    @update
    ...
    s.s_DOT_ostream_DOT_msg = Wire( Bits60 )
    @update
    def ostruct_s_DOT_ostream_DOT_msg():
      s.ostream.msg.payload @= s.s_DOT_ostream_DOT_msg[0:48]
      s.ostream.msg.opaque @= s.s_DOT_ostream_DOT_msg[48:56]
      s.ostream.msg.dest @= s.s_DOT_ostream_DOT_msg[56:58]
      s.ostream.msg.src @= s.s_DOT_ostream_DOT_msg[58:60]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VCacheResp2NetMsg_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VCacheResp2NetMsg_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 0:
      s._ffi_inst.VCacheResp2NetMsg_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
