...
#include "obj_dir_ProcAlt_noparam/VProcAlt_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_ProcAlt_noparam/VProcAlt_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  // Exposed methods
  VProcAlt_noparam_t * VProcAlt_noparam_create_model( const char * );
  void VProcAlt_noparam_destroy_model( VProcAlt_noparam_t *);
  void VProcAlt_noparam_comb_eval( VProcAlt_noparam_t * );
  void VProcAlt_noparam_seq_eval( VProcAlt_noparam_t * );
  void VProcAlt_noparam_assert_on( VProcAlt_noparam_t *, bool );
  bool VProcAlt_noparam_has_assert_fired( VProcAlt_noparam_t * );
  ...
  #if VLINETRACE
  void VProcAlt_noparam_line_trace( VProcAlt_noparam_t *, char * );
  #endif
...
VProcAlt_noparam_t * VProcAlt_noparam_create_model( const char *vcd_filename ) {

  VProcAlt_noparam_t  * m;
  VProcAlt_noparam * model;
  ...
  m     = new VProcAlt_noparam_t;
  model = new VProcAlt_noparam(context_ptr);
...
void VProcAlt_noparam_destroy_model( VProcAlt_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcAlt_noparam * model = (VProcAlt_noparam *) m->_cffi_model;
...
void VProcAlt_noparam_comb_eval( VProcAlt_noparam_t * m ) {
...
void VProcAlt_noparam_seq_eval( VProcAlt_noparam_t * m ) {
...
void VProcAlt_noparam_assert_on( VProcAlt_noparam_t * m, bool enable ) {
...
bool VProcAlt_noparam_has_assert_fired( VProcAlt_noparam_t * m ) {
...
#if VLINETRACE
void VProcAlt_noparam_line_trace( VProcAlt_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_ProcAlt_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.ProcAlt_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VProcAlt_noparam::line_trace( words );
