//========================================================================
// VCacheAlt__p_num_banks_4_v.cpp
//========================================================================
...
#include "obj_dir_CacheAlt__p_num_banks_4/VCacheAlt___05Fp_num_banks_4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheAlt__p_num_banks_4/VCacheAlt___05Fp_num_banks_4__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCacheAlt__p_num_banks_4_t;

  // Exposed methods
  VCacheAlt__p_num_banks_4_t * VCacheAlt__p_num_banks_4_create_model( const char * );
  void VCacheAlt__p_num_banks_4_destroy_model( VCacheAlt__p_num_banks_4_t *);
  void VCacheAlt__p_num_banks_4_comb_eval( VCacheAlt__p_num_banks_4_t * );
  void VCacheAlt__p_num_banks_4_seq_eval( VCacheAlt__p_num_banks_4_t * );
  void VCacheAlt__p_num_banks_4_assert_on( VCacheAlt__p_num_banks_4_t *, bool );
  bool VCacheAlt__p_num_banks_4_has_assert_fired( VCacheAlt__p_num_banks_4_t * );
  ...
  #if VLINETRACE
  void VCacheAlt__p_num_banks_4_line_trace( VCacheAlt__p_num_banks_4_t *, char * );
  #endif
...
VCacheAlt__p_num_banks_4_t * VCacheAlt__p_num_banks_4_create_model( const char *vcd_filename ) {

  VCacheAlt__p_num_banks_4_t  * m;
  VCacheAlt___05Fp_num_banks_4 * model;
  ...
  m     = new VCacheAlt__p_num_banks_4_t;
  model = new VCacheAlt___05Fp_num_banks_4(context_ptr);
...
void VCacheAlt__p_num_banks_4_destroy_model( VCacheAlt__p_num_banks_4_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheAlt___05Fp_num_banks_4 * model = (VCacheAlt___05Fp_num_banks_4 *) m->_cffi_model;
...
void VCacheAlt__p_num_banks_4_comb_eval( VCacheAlt__p_num_banks_4_t * m ) {
...
void VCacheAlt__p_num_banks_4_seq_eval( VCacheAlt__p_num_banks_4_t * m ) {
...
void VCacheAlt__p_num_banks_4_assert_on( VCacheAlt__p_num_banks_4_t * m, bool enable ) {
...
bool VCacheAlt__p_num_banks_4_has_assert_fired( VCacheAlt__p_num_banks_4_t * m ) {
...
#if VLINETRACE
void VCacheAlt__p_num_banks_4_line_trace( VCacheAlt__p_num_banks_4_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheAlt___05Fp_num_banks_4__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheAlt__p_num_banks_4.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheAlt___05Fp_num_banks_4::line_trace( words );
