...
extern "C" {
  ...
  #if VLINETRACE
  void VProcDpathAlu_noparam_line_trace( VProcDpathAlu_noparam_t *, char * );
  #endif
...
VProcDpathAlu_noparam_t * VProcDpathAlu_noparam_create_model( const char *vcd_filename ) {
  ...
  m     = new VProcDpathAlu_noparam_t;
  model = new VProcDpathAlu_noparam(context_ptr);
...
void VProcDpathAlu_noparam_destroy_model( VProcDpathAlu_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VProcDpathAlu_noparam * model = (VProcDpathAlu_noparam *) m->_cffi_model;
...
void VProcDpathAlu_noparam_comb_eval( VProcDpathAlu_noparam_t * m ) {
...
void VProcDpathAlu_noparam_seq_eval( VProcDpathAlu_noparam_t * m ) {
...
void VProcDpathAlu_noparam_assert_on( VProcDpathAlu_noparam_t * m, bool enable ) {
...
bool VProcDpathAlu_noparam_has_assert_fired( VProcDpathAlu_noparam_t * m ) {
...
#if VLINETRACE
void VProcDpathAlu_noparam_line_trace( VProcDpathAlu_noparam_t * m, char* str ) {
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.ProcDpathAlu_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VProcDpathAlu_noparam::line_trace( words );
