//========================================================================
// VNetRouter__p_msg_nbits_44_v.cpp
//========================================================================
...
#include "obj_dir_NetRouter__p_msg_nbits_44/VNetRouter___05Fp_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetRouter__p_msg_nbits_44/VNetRouter___05Fp_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
VNetRouter__p_msg_nbits_44_t * VNetRouter__p_msg_nbits_44_create_model( const char *vcd_filename ) {

  VNetRouter__p_msg_nbits_44_t  * m;
  VNetRouter___05Fp_msg_nbits_44 * model;
  ...
  m     = new VNetRouter__p_msg_nbits_44_t;
  model = new VNetRouter___05Fp_msg_nbits_44(context_ptr);
...
void VNetRouter__p_msg_nbits_44_destroy_model( VNetRouter__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetRouter___05Fp_msg_nbits_44 * model = (VNetRouter___05Fp_msg_nbits_44 *) m->_cffi_model;
...
void VNetRouter__p_msg_nbits_44_comb_eval( VNetRouter__p_msg_nbits_44_t * m ) {
...
void VNetRouter__p_msg_nbits_44_seq_eval( VNetRouter__p_msg_nbits_44_t * m ) {
...
void VNetRouter__p_msg_nbits_44_assert_on( VNetRouter__p_msg_nbits_44_t * m, bool enable ) {
...
bool VNetRouter__p_msg_nbits_44_has_assert_fired( VNetRouter__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void VNetRouter__p_msg_nbits_44_line_trace( VNetRouter__p_msg_nbits_44_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_NetRouter___05Fp_msg_nbits_44__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.NetRouter__p_msg_nbits_44.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VNetRouter___05Fp_msg_nbits_44::line_trace( words );
