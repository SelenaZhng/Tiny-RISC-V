//========================================================================
// VCacheBase__p_num_banks_1_v.cpp
//========================================================================
...
#include "obj_dir_CacheBase__p_num_banks_1/VCacheBase___05Fp_num_banks_1.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheBase__p_num_banks_1/VCacheBase___05Fp_num_banks_1__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCacheBase__p_num_banks_1_t;

  // Exposed methods
  VCacheBase__p_num_banks_1_t * VCacheBase__p_num_banks_1_create_model( const char * );
  void VCacheBase__p_num_banks_1_destroy_model( VCacheBase__p_num_banks_1_t *);
  void VCacheBase__p_num_banks_1_comb_eval( VCacheBase__p_num_banks_1_t * );
  void VCacheBase__p_num_banks_1_seq_eval( VCacheBase__p_num_banks_1_t * );
  void VCacheBase__p_num_banks_1_assert_on( VCacheBase__p_num_banks_1_t *, bool );
  bool VCacheBase__p_num_banks_1_has_assert_fired( VCacheBase__p_num_banks_1_t * );
  ...
  #if VLINETRACE
  void VCacheBase__p_num_banks_1_line_trace( VCacheBase__p_num_banks_1_t *, char * );
  #endif
...
VCacheBase__p_num_banks_1_t * VCacheBase__p_num_banks_1_create_model( const char *vcd_filename ) {

  VCacheBase__p_num_banks_1_t  * m;
  VCacheBase___05Fp_num_banks_1 * model;
  ...
  m     = new VCacheBase__p_num_banks_1_t;
  model = new VCacheBase___05Fp_num_banks_1(context_ptr);
...
void VCacheBase__p_num_banks_1_destroy_model( VCacheBase__p_num_banks_1_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheBase___05Fp_num_banks_1 * model = (VCacheBase___05Fp_num_banks_1 *) m->_cffi_model;
...
void VCacheBase__p_num_banks_1_comb_eval( VCacheBase__p_num_banks_1_t * m ) {
...
void VCacheBase__p_num_banks_1_seq_eval( VCacheBase__p_num_banks_1_t * m ) {
...
void VCacheBase__p_num_banks_1_assert_on( VCacheBase__p_num_banks_1_t * m, bool enable ) {
...
bool VCacheBase__p_num_banks_1_has_assert_fired( VCacheBase__p_num_banks_1_t * m ) {
...
#if VLINETRACE
void VCacheBase__p_num_banks_1_line_trace( VCacheBase__p_num_banks_1_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheBase___05Fp_num_banks_1__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheBase__p_num_banks_1.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheBase___05Fp_num_banks_1::line_trace( words );
