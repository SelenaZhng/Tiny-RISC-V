                    ...
                    : ((4U & (IData)(vlSelf->fn)) ? 
                       ((2U & (IData)(vlSelf->fn)) ? 
                        ((1U & (IData)(vlSelf->fn))
                          ? (vlSelf->in0 >> (0x1fU 
                                             & vlSelf->in1))
                          : VL_SHIFTRS_III(32,32,5, vlSelf->in0, 
                                           (0x1fU & vlSelf->in1)))
                         : ((1U & (IData)(vlSelf->fn))
...
#endif
            VL_FATAL_MT("lab2_proc/ProcDpathAlu.v", 69, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("lab2_proc/ProcDpathAlu.v", 69, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("lab2_proc/ProcDpathAlu.v", 69, "", "Active region did not converge.");
            }
