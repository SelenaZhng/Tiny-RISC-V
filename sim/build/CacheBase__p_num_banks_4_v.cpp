//========================================================================
// VCacheBase__p_num_banks_4_v.cpp
//========================================================================
...
#include "obj_dir_CacheBase__p_num_banks_4/VCacheBase___05Fp_num_banks_4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheBase__p_num_banks_4/VCacheBase___05Fp_num_banks_4__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VCacheBase__p_num_banks_4_t;

  // Exposed methods
  VCacheBase__p_num_banks_4_t * VCacheBase__p_num_banks_4_create_model( const char * );
  void VCacheBase__p_num_banks_4_destroy_model( VCacheBase__p_num_banks_4_t *);
  void VCacheBase__p_num_banks_4_comb_eval( VCacheBase__p_num_banks_4_t * );
  void VCacheBase__p_num_banks_4_seq_eval( VCacheBase__p_num_banks_4_t * );
  void VCacheBase__p_num_banks_4_assert_on( VCacheBase__p_num_banks_4_t *, bool );
  bool VCacheBase__p_num_banks_4_has_assert_fired( VCacheBase__p_num_banks_4_t * );
  ...
  #if VLINETRACE
  void VCacheBase__p_num_banks_4_line_trace( VCacheBase__p_num_banks_4_t *, char * );
  #endif
...
VCacheBase__p_num_banks_4_t * VCacheBase__p_num_banks_4_create_model( const char *vcd_filename ) {

  VCacheBase__p_num_banks_4_t  * m;
  VCacheBase___05Fp_num_banks_4 * model;
  ...
  m     = new VCacheBase__p_num_banks_4_t;
  model = new VCacheBase___05Fp_num_banks_4(context_ptr);
...
void VCacheBase__p_num_banks_4_destroy_model( VCacheBase__p_num_banks_4_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheBase___05Fp_num_banks_4 * model = (VCacheBase___05Fp_num_banks_4 *) m->_cffi_model;
...
void VCacheBase__p_num_banks_4_comb_eval( VCacheBase__p_num_banks_4_t * m ) {
...
void VCacheBase__p_num_banks_4_seq_eval( VCacheBase__p_num_banks_4_t * m ) {
...
void VCacheBase__p_num_banks_4_assert_on( VCacheBase__p_num_banks_4_t * m, bool enable ) {
...
bool VCacheBase__p_num_banks_4_has_assert_fired( VCacheBase__p_num_banks_4_t * m ) {
...
#if VLINETRACE
void VCacheBase__p_num_banks_4_line_trace( VCacheBase__p_num_banks_4_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheBase___05Fp_num_banks_4__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheBase__p_num_banks_4.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheBase___05Fp_num_banks_4::line_trace( words );
