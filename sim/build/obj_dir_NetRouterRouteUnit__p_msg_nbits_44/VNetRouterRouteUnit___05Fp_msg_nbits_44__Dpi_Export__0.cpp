...
void VNetRouterRouteUnit___05Fp_msg_nbits_44::line_trace(svBitVecVal* trace_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNetRouterRouteUnit___05Fp_msg_nbits_44___024root::line_trace\n"); );
    // Init
    ...
    VNetRouterRouteUnit___05Fp_msg_nbits_44__Vcb_line_trace_t __Vcb = (VNetRouterRouteUnit___05Fp_msg_nbits_44__Vcb_line_trace_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_W_SVBV(4096,trace_str__Vcvt,trace_str + 0);
(*__Vcb)((VNetRouterRouteUnit___05Fp_msg_nbits_44__Syms*)(__Vscopep->symsp()), trace_str__Vcvt);
