...
#include "obj_dir_MemResp2NetMsg_noparam/VMemResp2NetMsg_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MemResp2NetMsg_noparam/VMemResp2NetMsg_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void VMemResp2NetMsg_noparam_line_trace( VMemResp2NetMsg_noparam_t *, char * );
  #endif
...
VMemResp2NetMsg_noparam_t * VMemResp2NetMsg_noparam_create_model( const char *vcd_filename ) {

  VMemResp2NetMsg_noparam_t  * m;
  VMemResp2NetMsg_noparam * model;
  ...
  m     = new VMemResp2NetMsg_noparam_t;
  model = new VMemResp2NetMsg_noparam(context_ptr);
...
void VMemResp2NetMsg_noparam_destroy_model( VMemResp2NetMsg_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VMemResp2NetMsg_noparam * model = (VMemResp2NetMsg_noparam *) m->_cffi_model;
...
void VMemResp2NetMsg_noparam_comb_eval( VMemResp2NetMsg_noparam_t * m ) {
...
void VMemResp2NetMsg_noparam_seq_eval( VMemResp2NetMsg_noparam_t * m ) {
...
void VMemResp2NetMsg_noparam_assert_on( VMemResp2NetMsg_noparam_t * m, bool enable ) {
...
bool VMemResp2NetMsg_noparam_has_assert_fired( VMemResp2NetMsg_noparam_t * m ) {
...
#if VLINETRACE
void VMemResp2NetMsg_noparam_line_trace( VMemResp2NetMsg_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_MemResp2NetMsg_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.MemResp2NetMsg_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VMemResp2NetMsg_noparam::line_trace( words );
