...
#include "obj_dir_SingleCoreSys_noparam/VSingleCoreSys_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_SingleCoreSys_noparam/VSingleCoreSys_noparam__Syms.h"
#include "svdpi.h"
#endif
...
VSingleCoreSys_noparam_t * VSingleCoreSys_noparam_create_model( const char *vcd_filename ) {

  VSingleCoreSys_noparam_t  * m;
  VSingleCoreSys_noparam * model;
  ...
  m     = new VSingleCoreSys_noparam_t;
  model = new VSingleCoreSys_noparam(context_ptr);
...
void VSingleCoreSys_noparam_destroy_model( VSingleCoreSys_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VSingleCoreSys_noparam * model = (VSingleCoreSys_noparam *) m->_cffi_model;
...
void VSingleCoreSys_noparam_comb_eval( VSingleCoreSys_noparam_t * m ) {
...
void VSingleCoreSys_noparam_seq_eval( VSingleCoreSys_noparam_t * m ) {
...
void VSingleCoreSys_noparam_assert_on( VSingleCoreSys_noparam_t * m, bool enable ) {
...
bool VSingleCoreSys_noparam_has_assert_fired( VSingleCoreSys_noparam_t * m ) {
...
#if VLINETRACE
void VSingleCoreSys_noparam_line_trace( VSingleCoreSys_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_SingleCoreSys_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.SingleCoreSys_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VSingleCoreSys_noparam::line_trace( words );
