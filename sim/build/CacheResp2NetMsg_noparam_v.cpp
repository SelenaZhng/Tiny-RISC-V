//========================================================================
// VCacheResp2NetMsg_noparam_v.cpp
//========================================================================
...
#include "obj_dir_CacheResp2NetMsg_noparam/VCacheResp2NetMsg_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheResp2NetMsg_noparam/VCacheResp2NetMsg_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void VCacheResp2NetMsg_noparam_line_trace( VCacheResp2NetMsg_noparam_t *, char * );
  #endif
...
VCacheResp2NetMsg_noparam_t * VCacheResp2NetMsg_noparam_create_model( const char *vcd_filename ) {

  VCacheResp2NetMsg_noparam_t  * m;
  VCacheResp2NetMsg_noparam * model;
  ...
  m     = new VCacheResp2NetMsg_noparam_t;
  model = new VCacheResp2NetMsg_noparam(context_ptr);
...
void VCacheResp2NetMsg_noparam_destroy_model( VCacheResp2NetMsg_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheResp2NetMsg_noparam * model = (VCacheResp2NetMsg_noparam *) m->_cffi_model;
...
void VCacheResp2NetMsg_noparam_comb_eval( VCacheResp2NetMsg_noparam_t * m ) {
...
void VCacheResp2NetMsg_noparam_seq_eval( VCacheResp2NetMsg_noparam_t * m ) {
...
void VCacheResp2NetMsg_noparam_assert_on( VCacheResp2NetMsg_noparam_t * m, bool enable ) {
...
bool VCacheResp2NetMsg_noparam_has_assert_fired( VCacheResp2NetMsg_noparam_t * m ) {
...
#if VLINETRACE
void VCacheResp2NetMsg_noparam_line_trace( VCacheResp2NetMsg_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheResp2NetMsg_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheResp2NetMsg_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheResp2NetMsg_noparam::line_trace( words );
