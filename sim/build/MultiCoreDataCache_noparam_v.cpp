//========================================================================
// VMultiCoreDataCache_noparam_v.cpp
//========================================================================
...
#include "obj_dir_MultiCoreDataCache_noparam/VMultiCoreDataCache_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MultiCoreDataCache_noparam/VMultiCoreDataCache_noparam__Syms.h"
#include "svdpi.h"
#endif
...
VMultiCoreDataCache_noparam_t * VMultiCoreDataCache_noparam_create_model( const char *vcd_filename ) {

  VMultiCoreDataCache_noparam_t  * m;
  VMultiCoreDataCache_noparam * model;
  ...
  m     = new VMultiCoreDataCache_noparam_t;
  model = new VMultiCoreDataCache_noparam(context_ptr);
  ...
  for ( int i_0 = 0; i_0 < 4; i_0++ )
    ...
    m->proc2cache_reqstream_msg[i_0] = model->proc2cache_reqstream_msg[i_0];

  for ( int i_0 = 0; i_0 < 4; i_0++ )

    m->proc2cache_reqstream_rdy[i_0] = &model->proc2cache_reqstream_rdy[i_0];

  for ( int i_0 = 0; i_0 < 4; i_0++ )

    m->proc2cache_reqstream_val[i_0] = &model->proc2cache_reqstream_val[i_0];

  for ( int i_0 = 0; i_0 < 4; i_0++ )

    m->proc2cache_respstream_msg[i_0] = &model->proc2cache_respstream_msg[i_0];

  for ( int i_0 = 0; i_0 < 4; i_0++ )

    m->proc2cache_respstream_rdy[i_0] = &model->proc2cache_respstream_rdy[i_0];

  for ( int i_0 = 0; i_0 < 4; i_0++ )

    m->proc2cache_respstream_val[i_0] = &model->proc2cache_respstream_val[i_0];
...
void VMultiCoreDataCache_noparam_destroy_model( VMultiCoreDataCache_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VMultiCoreDataCache_noparam * model = (VMultiCoreDataCache_noparam *) m->_cffi_model;
...
void VMultiCoreDataCache_noparam_comb_eval( VMultiCoreDataCache_noparam_t * m ) {
...
void VMultiCoreDataCache_noparam_seq_eval( VMultiCoreDataCache_noparam_t * m ) {
...
void VMultiCoreDataCache_noparam_assert_on( VMultiCoreDataCache_noparam_t * m, bool enable ) {
...
bool VMultiCoreDataCache_noparam_has_assert_fired( VMultiCoreDataCache_noparam_t * m ) {
...
#if VLINETRACE
void VMultiCoreDataCache_noparam_line_trace( VMultiCoreDataCache_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_MultiCoreDataCache_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.MultiCoreDataCache_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VMultiCoreDataCache_noparam::line_trace( words );
