...
// PyMTL VerilogPlaceholder CacheResp2NetMsg Definition
// At /home/scz6/ece4750/lab-group74/sim/lab4_sys/NetMsgAdapters.py

//***********************************************************
// Pickled source file of placeholder CacheResp2NetMsg_noparam
//***********************************************************

//-----------------------------------------------------------
// Dependency of placeholder CacheResp2NetMsg
//-----------------------------------------------------------

`ifndef CACHERESP2NETMSG
`define CACHERESP2NETMSG

// The source code below are included because they are specified
// as the v_libs Verilog placeholder option of component CacheResp2NetMsg_noparam.
...
// End of all v_libs files for component CacheResp2NetMsg_noparam
...
`endif /* CACHERESP2NETMSG */
//-----------------------------------------------------------
// Wrapper of placeholder CacheResp2NetMsg_noparam
//-----------------------------------------------------------

`ifndef CACHERESP2NETMSG_NOPARAM
`define CACHERESP2NETMSG_NOPARAM

module CacheResp2NetMsg_noparam
(
  input logic reset,
  input logic clk,
  input logic [48-1:0] istream_msg ,
  output logic [1-1:0] istream_rdy ,
  input logic [1-1:0] istream_val ,
  output logic [60-1:0] ostream_msg ,
  input logic [1-1:0] ostream_rdy ,
  output logic [1-1:0] ostream_val 
);
  lab4_sys_CacheResp2NetMsg
  #(
  ) v
  (
...
`endif /* CACHERESP2NETMSG_NOPARAM */
