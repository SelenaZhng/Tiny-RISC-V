//========================================================================
// VCacheAlt__p_num_banks_1_v.cpp
//========================================================================
...
#include "obj_dir_CacheAlt__p_num_banks_1/VCacheAlt___05Fp_num_banks_1.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_CacheAlt__p_num_banks_1/VCacheAlt___05Fp_num_banks_1__Syms.h"
#include "svdpi.h"
#endif
...
VCacheAlt__p_num_banks_1_t * VCacheAlt__p_num_banks_1_create_model( const char *vcd_filename ) {

  VCacheAlt__p_num_banks_1_t  * m;
  VCacheAlt___05Fp_num_banks_1 * model;
  ...
  m     = new VCacheAlt__p_num_banks_1_t;
  model = new VCacheAlt___05Fp_num_banks_1(context_ptr);
...
void VCacheAlt__p_num_banks_1_destroy_model( VCacheAlt__p_num_banks_1_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VCacheAlt___05Fp_num_banks_1 * model = (VCacheAlt___05Fp_num_banks_1 *) m->_cffi_model;
...
void VCacheAlt__p_num_banks_1_comb_eval( VCacheAlt__p_num_banks_1_t * m ) {
...
void VCacheAlt__p_num_banks_1_seq_eval( VCacheAlt__p_num_banks_1_t * m ) {
...
void VCacheAlt__p_num_banks_1_assert_on( VCacheAlt__p_num_banks_1_t * m, bool enable ) {
...
bool VCacheAlt__p_num_banks_1_has_assert_fired( VCacheAlt__p_num_banks_1_t * m ) {
...
#if VLINETRACE
void VCacheAlt__p_num_banks_1_line_trace( VCacheAlt__p_num_banks_1_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_CacheAlt___05Fp_num_banks_1__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.CacheAlt__p_num_banks_1.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VCacheAlt___05Fp_num_banks_1::line_trace( words );
