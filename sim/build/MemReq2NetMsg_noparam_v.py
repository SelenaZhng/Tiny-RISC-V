...
#-------------------------------------------------------------------------
# MemReq2NetMsg_noparam
#-------------------------------------------------------------------------

class MemReq2NetMsg_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VMemReq2NetMsg_noparam_t;

      VMemReq2NetMsg_noparam_t * VMemReq2NetMsg_noparam_create_model( const char * );
      void VMemReq2NetMsg_noparam_destroy_model( VMemReq2NetMsg_noparam_t *);
      void VMemReq2NetMsg_noparam_comb_eval( VMemReq2NetMsg_noparam_t * );
      void VMemReq2NetMsg_noparam_seq_eval( VMemReq2NetMsg_noparam_t * );
      void VMemReq2NetMsg_noparam_assert_on( VMemReq2NetMsg_noparam_t *, bool );
      bool VMemReq2NetMsg_noparam_has_assert_fired( VMemReq2NetMsg_noparam_t * );
    ...
    #       'libMemReq2NetMsg_noparam_v.so', os.path.getmtime( './libMemReq2NetMsg_noparam_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libMemReq2NetMsg_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    MemReq2NetMsg_noparam.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VMemReq2NetMsg_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if int(s._ip_cfg.vl_trace):
      if bool(s._ip_cfg.vl_trace_filename):
        ...
        verilator_vcd_file = "MemReq2NetMsg_noparam.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VMemReq2NetMsg_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VMemReq2NetMsg_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VMemReq2NetMsg_noparam_seq_eval

    # declare the port interface
    s.src_id = InPort( Bits2 )
    s.istream = IStreamIfc( MemReqMsg__type__4__opaque_8__addr_32__len_4__data_128 )
    s.ostream = OStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_176 )

    # update blocks that converts ffi interface to/from pymtl ports
    
    s.s_DOT_src_id = Wire( Bits2 )
    @update
    def isignal_s_DOT_src_id():
      s.s_DOT_src_id @= s.src_id
    
    s.s_DOT_istream_DOT_msg = Wire( Bits176 )
    @update
    ...
    s.s_DOT_ostream_DOT_msg = Wire( Bits188 )
    @update
    def ostruct_s_DOT_ostream_DOT_msg():
      s.ostream.msg.payload @= s.s_DOT_ostream_DOT_msg[0:176]
      s.ostream.msg.opaque @= s.s_DOT_ostream_DOT_msg[176:184]
      s.ostream.msg.dest @= s.s_DOT_ostream_DOT_msg[184:186]
      s.ostream.msg.src @= s.s_DOT_ostream_DOT_msg[186:188]
    ...
    def comb_upblk():
      ...
      _ffi_m.src_id[0] = int(s.s_DOT_src_id)
      ...
      x[4] = int(s.s_DOT_istream_DOT_msg[128:160])
      x[5] = int(s.s_DOT_istream_DOT_msg[160:176])
      ...
      s.s_DOT_ostream_DOT_msg[128:160] @= x[4]
      s.s_DOT_ostream_DOT_msg[160:188] @= x[5]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VMemReq2NetMsg_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VMemReq2NetMsg_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 0:
      s._ffi_inst.VMemReq2NetMsg_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
      return s._convert_string( s._ffi_m._cffi_line_trace_str ).decode('ascii')
    else:
      return f' src_id={s.src_id}, istream.msg={s.istream.msg}, istream.rdy={s.istream.rdy}, istream.val={s.istream.val}, ostream.msg={s.ostream.msg}, ostream.rdy={s.ostream.rdy}, ostream.val={s.ostream.val},'
