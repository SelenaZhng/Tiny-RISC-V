...
// PyMTL VerilogPlaceholder NetMsg2MemReq Definition
// At /home/scz6/ece4750/lab-group74/sim/lab4_sys/NetMsgAdapters.py

//***********************************************************
// Pickled source file of placeholder NetMsg2MemReq_noparam
//***********************************************************

//-----------------------------------------------------------
// Dependency of placeholder NetMsg2MemReq
//-----------------------------------------------------------

`ifndef NETMSG2MEMREQ
`define NETMSG2MEMREQ

// The source code below are included because they are specified
// as the v_libs Verilog placeholder option of component NetMsg2MemReq_noparam.
...
// End of all v_libs files for component NetMsg2MemReq_noparam
...
`endif /* NETMSG2MEMREQ */
//-----------------------------------------------------------
// Wrapper of placeholder NetMsg2MemReq_noparam
//-----------------------------------------------------------

`ifndef NETMSG2MEMREQ_NOPARAM
`define NETMSG2MEMREQ_NOPARAM

module NetMsg2MemReq_noparam
(
  input logic reset,
  input logic clk,
  input logic [188-1:0] istream_msg ,
  output logic [1-1:0] istream_rdy ,
  input logic [1-1:0] istream_val ,
  output logic [176-1:0] ostream_msg ,
  input logic [1-1:0] ostream_rdy ,
  output logic [1-1:0] ostream_val 
);
  lab4_sys_NetMsg2MemReq
  #(
  ) v
  (
