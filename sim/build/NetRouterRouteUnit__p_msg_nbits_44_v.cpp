...
#include "obj_dir_NetRouterRouteUnit__p_msg_nbits_44/VNetRouterRouteUnit___05Fp_msg_nbits_44.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_NetRouterRouteUnit__p_msg_nbits_44/VNetRouterRouteUnit___05Fp_msg_nbits_44__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  // Exposed methods
  VNetRouterRouteUnit__p_msg_nbits_44_t * VNetRouterRouteUnit__p_msg_nbits_44_create_model( const char * );
  void VNetRouterRouteUnit__p_msg_nbits_44_destroy_model( VNetRouterRouteUnit__p_msg_nbits_44_t *);
  void VNetRouterRouteUnit__p_msg_nbits_44_comb_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * );
  void VNetRouterRouteUnit__p_msg_nbits_44_seq_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * );
  void VNetRouterRouteUnit__p_msg_nbits_44_assert_on( VNetRouterRouteUnit__p_msg_nbits_44_t *, bool );
  bool VNetRouterRouteUnit__p_msg_nbits_44_has_assert_fired( VNetRouterRouteUnit__p_msg_nbits_44_t * );
  ...
  #if VLINETRACE
  void VNetRouterRouteUnit__p_msg_nbits_44_line_trace( VNetRouterRouteUnit__p_msg_nbits_44_t *, char * );
  #endif
...
VNetRouterRouteUnit__p_msg_nbits_44_t * VNetRouterRouteUnit__p_msg_nbits_44_create_model( const char *vcd_filename ) {

  VNetRouterRouteUnit__p_msg_nbits_44_t  * m;
  VNetRouterRouteUnit___05Fp_msg_nbits_44 * model;
  ...
  m     = new VNetRouterRouteUnit__p_msg_nbits_44_t;
  model = new VNetRouterRouteUnit___05Fp_msg_nbits_44(context_ptr);
  ...
  for ( int i_0 = 0; i_0 < 3; i_0++ )
    ...
    m->ostream_msg[i_0] = &model->ostream_msg[i_0];

  for ( int i_0 = 0; i_0 < 3; i_0++ )

    m->ostream_rdy[i_0] = &model->ostream_rdy[i_0];

  for ( int i_0 = 0; i_0 < 3; i_0++ )

    m->ostream_val[i_0] = &model->ostream_val[i_0];
...
void VNetRouterRouteUnit__p_msg_nbits_44_destroy_model( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VNetRouterRouteUnit___05Fp_msg_nbits_44 * model = (VNetRouterRouteUnit___05Fp_msg_nbits_44 *) m->_cffi_model;
...
void VNetRouterRouteUnit__p_msg_nbits_44_comb_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {
...
void VNetRouterRouteUnit__p_msg_nbits_44_seq_eval( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {
...
void VNetRouterRouteUnit__p_msg_nbits_44_assert_on( VNetRouterRouteUnit__p_msg_nbits_44_t * m, bool enable ) {
...
bool VNetRouterRouteUnit__p_msg_nbits_44_has_assert_fired( VNetRouterRouteUnit__p_msg_nbits_44_t * m ) {
...
#if VLINETRACE
void VNetRouterRouteUnit__p_msg_nbits_44_line_trace( VNetRouterRouteUnit__p_msg_nbits_44_t * m, char* str ) {
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.NetRouterRouteUnit__p_msg_nbits_44.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VNetRouterRouteUnit___05Fp_msg_nbits_44::line_trace( words );
