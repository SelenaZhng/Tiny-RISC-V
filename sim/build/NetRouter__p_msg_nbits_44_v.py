...
#=========================================================================
# VNetRouter__p_msg_nbits_44_v.py
#=========================================================================
...
#-------------------------------------------------------------------------
# NetRouter__p_msg_nbits_44
#-------------------------------------------------------------------------

class NetRouter__p_msg_nbits_44( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      typedef struct {
        ...
        uint64_t * ostream_msg[3];        
        uint8_t * ostream_rdy[3];        
        uint8_t * ostream_val[3];
      ...
      } VNetRouter__p_msg_nbits_44_t;

      VNetRouter__p_msg_nbits_44_t * VNetRouter__p_msg_nbits_44_create_model( const char * );
      void VNetRouter__p_msg_nbits_44_destroy_model( VNetRouter__p_msg_nbits_44_t *);
      void VNetRouter__p_msg_nbits_44_comb_eval( VNetRouter__p_msg_nbits_44_t * );
      void VNetRouter__p_msg_nbits_44_seq_eval( VNetRouter__p_msg_nbits_44_t * );
      void VNetRouter__p_msg_nbits_44_assert_on( VNetRouter__p_msg_nbits_44_t *, bool );
      bool VNetRouter__p_msg_nbits_44_has_assert_fired( VNetRouter__p_msg_nbits_44_t * );
      void VNetRouter__p_msg_nbits_44_line_trace( VNetRouter__p_msg_nbits_44_t *, char * );

    """)

    # Print the modification time stamp of the shared lib
    # print('Modification time of {}: {}'.format(
    #       'libNetRouter__p_msg_nbits_44_v.so', os.path.getmtime( './libNetRouter__p_msg_nbits_44_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libNetRouter__p_msg_nbits_44_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    NetRouter__p_msg_nbits_44.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VNetRouter__p_msg_nbits_44_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if int(s._ip_cfg.vl_trace):
      if bool(s._ip_cfg.vl_trace_filename):
        ...
        verilator_vcd_file = "NetRouter__p_msg_nbits_44.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VNetRouter__p_msg_nbits_44_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VNetRouter__p_msg_nbits_44_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VNetRouter__p_msg_nbits_44_seq_eval

    # declare the port interface
    s.router_id = InPort( Bits4 )
    s.istream = [ IStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_32 ) for _ in range(3) ]
    s.ostream = [ OStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_32 ) for _ in range(3) ]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VNetRouter__p_msg_nbits_44_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VNetRouter__p_msg_nbits_44_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 1:
      s._ffi_inst.VNetRouter__p_msg_nbits_44_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
      return s._convert_string( s._ffi_m._cffi_line_trace_str ).decode('ascii')
    else:
      return f' clk={s.clk}, reset={s.reset}, router_id={s.router_id}, istream[0].msg={s.istream[0].msg}, istream[1].msg={s.istream[1].msg}, istream[2].msg={s.istream[2].msg}, istream[0].rdy={s.istream[0].rdy}, istream[1].rdy={s.istream[1].rdy}, istream[2].rdy={s.istream[2].rdy}, istream[0].val={s.istream[0].val}, istream[1].val={s.istream[1].val}, istream[2].val={s.istream[2].val}, ostream[0].msg={s.ostream[0].msg}, ostream[1].msg={s.ostream[1].msg}, ostream[2].msg={s.ostream[2].msg}, ostream[0].rdy={s.ostream[0].rdy}, ostream[1].rdy={s.ostream[1].rdy}, ostream[2].rdy={s.ostream[2].rdy}, ostream[0].val={s.ostream[0].val}, ostream[1].val={s.ostream[1].val}, ostream[2].val={s.ostream[2].val},'
