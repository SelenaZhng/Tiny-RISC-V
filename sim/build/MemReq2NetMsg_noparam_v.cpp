...
#include "obj_dir_MemReq2NetMsg_noparam/VMemReq2NetMsg_noparam.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_MemReq2NetMsg_noparam/VMemReq2NetMsg_noparam__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void VMemReq2NetMsg_noparam_line_trace( VMemReq2NetMsg_noparam_t *, char * );
  #endif
...
VMemReq2NetMsg_noparam_t * VMemReq2NetMsg_noparam_create_model( const char *vcd_filename ) {

  VMemReq2NetMsg_noparam_t  * m;
  VMemReq2NetMsg_noparam * model;
  ...
  m     = new VMemReq2NetMsg_noparam_t;
  model = new VMemReq2NetMsg_noparam(context_ptr);
...
void VMemReq2NetMsg_noparam_destroy_model( VMemReq2NetMsg_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VMemReq2NetMsg_noparam * model = (VMemReq2NetMsg_noparam *) m->_cffi_model;
...
void VMemReq2NetMsg_noparam_comb_eval( VMemReq2NetMsg_noparam_t * m ) {
...
void VMemReq2NetMsg_noparam_seq_eval( VMemReq2NetMsg_noparam_t * m ) {
...
void VMemReq2NetMsg_noparam_assert_on( VMemReq2NetMsg_noparam_t * m, bool enable ) {
...
bool VMemReq2NetMsg_noparam_has_assert_fired( VMemReq2NetMsg_noparam_t * m ) {
...
#if VLINETRACE
void VMemReq2NetMsg_noparam_line_trace( VMemReq2NetMsg_noparam_t * m, char* str ) {
  ...
  // which is called `v`.
  // svSetScope( &model->__VlSymsp->__Vscope_MemReq2NetMsg_noparam__v );
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.MemReq2NetMsg_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VMemReq2NetMsg_noparam::line_trace( words );
