...
class NetRouterSwitchUnit__p_msg_nbits_44( Component ):
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s._ffi_inst = s.ffi.dlopen('./libNetRouterSwitchUnit__p_msg_nbits_44_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    s._ffi_m = s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_seq_eval

    # declare the port interface
    s.istream = [ IStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_32 ) for _ in range(3) ]
    s.ostream = OStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_32 )
    ...
    def ostruct_s_DOT_ostream_DOT_msg():
      ...
      s.ostream.msg.dest @= s.s_DOT_ostream_DOT_msg[40:42]
      s.ostream.msg.src @= s.s_DOT_ostream_DOT_msg[42:44]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 1:
      s._ffi_inst.VNetRouterSwitchUnit__p_msg_nbits_44_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
      return s._convert_string( s._ffi_m._cffi_line_trace_str ).decode('ascii')
    else:
      return f' clk={s.clk}, reset={s.reset}, istream[0].msg={s.istream[0].msg}, istream[1].msg={s.istream[1].msg}, istream[2].msg={s.istream[2].msg}, istream[0].rdy={s.istream[0].rdy}, istream[1].rdy={s.istream[1].rdy}, istream[2].rdy={s.istream[2].rdy}, istream[0].val={s.istream[0].val}, istream[1].val={s.istream[1].val}, istream[2].val={s.istream[2].val}, ostream.msg={s.ostream.msg}, ostream.rdy={s.ostream.rdy}, ostream.val={s.ostream.val},'
