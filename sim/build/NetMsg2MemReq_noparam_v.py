...
#-------------------------------------------------------------------------
# NetMsg2MemReq_noparam
#-------------------------------------------------------------------------

class NetMsg2MemReq_noparam( Component ):
  id_ = 0
  ...
  def __init__( s, *args, **kwargs ):
    ...
    s.ffi.cdef("""
      ...
      } VNetMsg2MemReq_noparam_t;

      VNetMsg2MemReq_noparam_t * VNetMsg2MemReq_noparam_create_model( const char * );
      void VNetMsg2MemReq_noparam_destroy_model( VNetMsg2MemReq_noparam_t *);
      void VNetMsg2MemReq_noparam_comb_eval( VNetMsg2MemReq_noparam_t * );
      void VNetMsg2MemReq_noparam_seq_eval( VNetMsg2MemReq_noparam_t * );
      void VNetMsg2MemReq_noparam_assert_on( VNetMsg2MemReq_noparam_t *, bool );
      bool VNetMsg2MemReq_noparam_has_assert_fired( VNetMsg2MemReq_noparam_t * );
    ...
    #       'libNetMsg2MemReq_noparam_v.so', os.path.getmtime( './libNetMsg2MemReq_noparam_v.so' ) ))
    ...
    s._ffi_inst = s.ffi.dlopen('./libNetMsg2MemReq_noparam_v.so', s.ffi.RTLD_NODELETE | s.ffi.RTLD_NOW)

    # increment instance count
    NetMsg2MemReq_noparam.id_ += 1
  ...
  def finalize( s ):
    ...
    s._ffi_inst.VNetMsg2MemReq_noparam_destroy_model( s._ffi_m )
  ...
  def construct( s, *args, **kwargs ):
    ...
    if int(s._ip_cfg.vl_trace):
      if bool(s._ip_cfg.vl_trace_filename):
        ...
        verilator_vcd_file = "NetMsg2MemReq_noparam.verilator1.vcd"
    ...
    s._ffi_m = s._ffi_inst.VNetMsg2MemReq_noparam_create_model( ffi_vl_vcd_file )
    ...
    _ffi_m = s._ffi_m
    _ffi_inst_comb_eval = s._ffi_inst.VNetMsg2MemReq_noparam_comb_eval
    _ffi_inst_seq_eval  = s._ffi_inst.VNetMsg2MemReq_noparam_seq_eval

    # declare the port interface
    s.istream = IStreamIfc( NetMsg__src_2__dest_2__opaque_8__payload_176 )
    s.ostream = OStreamIfc( MemReqMsg__type__4__opaque_8__addr_32__len_4__data_128 )

    # update blocks that converts ffi interface to/from pymtl ports
    
    s.s_DOT_istream_DOT_msg = Wire( Bits188 )
    @update
    ...
    s.s_DOT_ostream_DOT_msg = Wire( Bits176 )
    @update
    def ostruct_s_DOT_ostream_DOT_msg():
      s.ostream.msg.data @= s.s_DOT_ostream_DOT_msg[0:128]
      s.ostream.msg.len @= s.s_DOT_ostream_DOT_msg[128:132]
      s.ostream.msg.addr @= s.s_DOT_ostream_DOT_msg[132:164]
      s.ostream.msg.opaque @= s.s_DOT_ostream_DOT_msg[164:172]
      s.ostream.msg.type_ @= s.s_DOT_ostream_DOT_msg[172:176]
    ...
    def comb_upblk():
      ...
      x[5] = int(s.s_DOT_istream_DOT_msg[160:188])
      ...
      s.s_DOT_ostream_DOT_msg[160:176] @= x[5]
    ...
    def seq_upblk():
      ...
      if s._ffi_inst.VNetMsg2MemReq_noparam_has_assert_fired( _ffi_m ):
        raise AssertionError("A Verilog assertion fired in the Verilator simulation!")

  def assert_on( s, enable ):
    assert isinstance( enable, bool )
    s._ffi_inst.VNetMsg2MemReq_noparam_assert_on( s._ffi_m, enable )

  def line_trace( s ):
    if 0:
      s._ffi_inst.VNetMsg2MemReq_noparam_line_trace( s._ffi_m, s._ffi_m._cffi_line_trace_str )
