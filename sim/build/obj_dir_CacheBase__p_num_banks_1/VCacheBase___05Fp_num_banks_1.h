...
#ifndef VERILATED_VCACHEBASE___05FP_NUM_BANKS_1_H_
#define VERILATED_VCACHEBASE___05FP_NUM_BANKS_1_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class VCacheBase___05Fp_num_banks_1__Syms;
class VCacheBase___05Fp_num_banks_1___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VCacheBase___05Fp_num_banks_1 VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VCacheBase___05Fp_num_banks_1___024root* const rootp;
    ...
    explicit VCacheBase___05Fp_num_banks_1(VerilatedContext* contextp, const char* name = "TOP");
    explicit VCacheBase___05Fp_num_banks_1(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VCacheBase___05Fp_num_banks_1();
  private:
    VL_UNCOPYABLE(VCacheBase___05Fp_num_banks_1);  ///< Copying not allowed
