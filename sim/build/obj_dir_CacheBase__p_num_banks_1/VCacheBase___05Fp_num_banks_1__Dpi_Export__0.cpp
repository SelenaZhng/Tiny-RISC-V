...
void VCacheBase___05Fp_num_banks_1::line_trace(svBitVecVal* trace_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VCacheBase___05Fp_num_banks_1___024root::line_trace\n"); );
    // Init
    ...
    VCacheBase___05Fp_num_banks_1__Vcb_line_trace_t __Vcb = (VCacheBase___05Fp_num_banks_1__Vcb_line_trace_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_W_SVBV(4096,trace_str__Vcvt,trace_str + 0);
(*__Vcb)((VCacheBase___05Fp_num_banks_1__Syms*)(__Vscopep->symsp()), trace_str__Vcvt);
