...
// PyMTL VerilogPlaceholder CacheNet Definition
// At /home/scz6/ece4750/lab-group74/sim/lab4_sys/CacheNet.py

//***********************************************************
// Pickled source file of placeholder CacheNet_noparam
//***********************************************************

//-----------------------------------------------------------
// Dependency of placeholder CacheNet
//-----------------------------------------------------------
...
// as the v_libs Verilog placeholder option of component CacheNet_noparam.
...
// End of all v_libs files for component CacheNet_noparam
...
`endif /* CACHENET */
//-----------------------------------------------------------
// Wrapper of placeholder CacheNet_noparam
//-----------------------------------------------------------

`ifndef CACHENET_NOPARAM
`define CACHENET_NOPARAM

module CacheNet_noparam
(
  input logic [1-1:0] clk ,
  input logic [1-1:0] reset ,
  output logic [78-1:0] net2cache_reqstream_msg [0:3],
  input logic [1-1:0] net2cache_reqstream_rdy [0:3],
  output logic [1-1:0] net2cache_reqstream_val [0:3],
  input logic [48-1:0] net2cache_respstream_msg [0:3],
  output logic [1-1:0] net2cache_respstream_rdy [0:3],
  input logic [1-1:0] net2cache_respstream_val [0:3],
  input logic [78-1:0] proc2net_reqstream_msg [0:3],
  output logic [1-1:0] proc2net_reqstream_rdy [0:3],
  input logic [1-1:0] proc2net_reqstream_val [0:3],
  output logic [48-1:0] proc2net_respstream_msg [0:3],
  input logic [1-1:0] proc2net_respstream_rdy [0:3],
  output logic [1-1:0] proc2net_respstream_val [0:3]
);
  lab4_sys_CacheNet
  #(
  ) v
  (
    .clk( clk ),
    .reset( reset ),
    .net2cache_reqstream_msg( net2cache_reqstream_msg ),
    .net2cache_reqstream_rdy( net2cache_reqstream_rdy ),
    .net2cache_reqstream_val( net2cache_reqstream_val ),
    .net2cache_respstream_msg( net2cache_respstream_msg ),
    .net2cache_respstream_rdy( net2cache_respstream_rdy ),
    .net2cache_respstream_val( net2cache_respstream_val ),
    .proc2net_reqstream_msg( proc2net_reqstream_msg ),
    .proc2net_reqstream_rdy( proc2net_reqstream_rdy ),
    .proc2net_reqstream_val( proc2net_reqstream_val ),
    .proc2net_respstream_msg( proc2net_respstream_msg ),
    .proc2net_respstream_rdy( proc2net_respstream_rdy ),
    .proc2net_respstream_val( proc2net_respstream_val )
  );
endmodule

`endif /* CACHENET_NOPARAM */
