...
class Tests:
  ...
  @pytest.mark.parametrize( "name,test", [
    ...
    asm_test( inst_add.gen_x0_test        ),
    asm_test( inst_add.gen_long_bypass_chain_test),
    asm_test( inst_add.gen_write_after_write_test),
    asm_test( inst_add.gen_hi_regs_carry_test)
  ])
