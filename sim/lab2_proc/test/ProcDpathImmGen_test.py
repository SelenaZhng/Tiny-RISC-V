...
def test_immgen_s( cmdline_opts ):
  ...
  run_test_vector_sim( dut, [
    ('imm_type inst                                imm*'),
    [ 1,       0b11111110000000000000000000000000, 0b11111111111111111111111111100000 ],
...
def test_immgen_u( cmdline_opts ):
  ...
  run_test_vector_sim( dut, [
    ('imm_type inst                                imm*'),
    [ 3,       0b00000000000011111111000000000000, 0b00000000000011111111000000000000],
    [ 3,       0b11111111111100000000000000000000, 0b11111111111100000000000000000000],
    [ 3,       0b10000000000000000000000000000000, 0b10000000000000000000000000000000],
  ], cmdline_opts )
...
def test_immgen_j( cmdline_opts ):
  ...
  run_test_vector_sim( dut, [
    ('imm_type inst                                imm*'),
    [ 4,       0b00000000000000000000000000000000, 0b00000000000000000000000000000000 ],
    [ 4,       0b11111111111111111111000000000000, 0b11111111111111111111111111111110 ],
    [ 4,       0b00000000001000000000000000000000, 0b00000000000000000000000000000010 ],
    [ 4,       0b00000000000100000000000000000000, 0b0000000000000000000000000000100000000000 ],
  ], cmdline_opts )
