...
void VSingleCoreSys_noparam::line_trace(svBitVecVal* trace_str) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSingleCoreSys_noparam___024root::line_trace\n"); );
    // Init
    ...
    VSingleCoreSys_noparam__Vcb_line_trace_t __Vcb = (VSingleCoreSys_noparam__Vcb_line_trace_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    VL_SET_W_SVBV(4096,trace_str__Vcvt,trace_str + 0);
(*__Vcb)((VSingleCoreSys_noparam__Syms*)(__Vscopep->symsp()), trace_str__Vcvt);
