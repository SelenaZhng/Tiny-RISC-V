...
#ifndef VERILATED_VSINGLECORESYS_NOPARAM_H_
#define VERILATED_VSINGLECORESYS_NOPARAM_H_  // guard

#include "verilated.h"
#include "svdpi.h"

class VSingleCoreSys_noparam__Syms;
class VSingleCoreSys_noparam___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VSingleCoreSys_noparam VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VSingleCoreSys_noparam___024root* const rootp;
    ...
    explicit VSingleCoreSys_noparam(VerilatedContext* contextp, const char* name = "TOP");
    explicit VSingleCoreSys_noparam(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VSingleCoreSys_noparam();
  private:
    VL_UNCOPYABLE(VSingleCoreSys_noparam);  ///< Copying not allowed
